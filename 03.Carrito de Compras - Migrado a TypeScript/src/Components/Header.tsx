...
type HeaderProps = {
  cart: GuitarItemT[]
  removeGuitar: (id: GuitarT["id"]) => void
  incrementCart: (item: GuitarItemT) => void
  decrementGuitar: (item: GuitarItemT) => void
  clearCart: () => void
  isEmpty: boolean
  cartTotal: number
}

const Header = ({ cart, removeGuitar, incrementCart, decrementGuitar, clearCart, isEmpty, cartTotal}: HeaderProps) => {
