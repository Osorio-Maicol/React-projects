                      ...
                      <tr key={item.id}>
                        ...
                        <td className="flex align-items-start gap-4">
                          <button
                            ...
                            onClick={()=>dispatch({type: "decrement-cart", payload:{item}})}
                          >
                            -
                          </button>
                          {item.quantity}
                          <button
                            type="button"
                            className="btn btn-dark"
                            onClick={()=>dispatch({type: "increment-cart", payload: {item}})}
                          >
                            +
                          </button>
                        </td>
                        <td>
                          <button
                            ...
                            type="button"
                            onClick={()=>dispatch({type: "remove-cart", payload: {id: item.id}})}
                          >
                            X
                          </button>
                        </td>
