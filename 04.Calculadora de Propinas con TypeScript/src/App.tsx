...
function App() {
  ...
  const {order, addItem, removeItem, propinas, setPorpinas, clearOrder} = useOrder()
    ...
    <>
      ...
      <main className="grid md:grid-cols-2 p-5">
        ...
        {order.length !==0? (
          ...
          <button className="w-full bg-blue-900 text-white capitalize p-3 font-bold rounded-md disabled:bg-blue-300 disabled:cursor-pointer" disabled={order.length == 0} onClick={clearOrder}>guardar orden</button>
        </div>
